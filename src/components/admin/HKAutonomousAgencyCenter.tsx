      ...
      {!compact && (
        <>
          ...
          <section className="grid gap-5 xl:grid-cols-4">
            ...
            <MiniModule title="AI Satış Asistanı" icon={<Target size={19} />} items={["Arama metni", "WhatsApp", "Teklif", "Toplantı", "Takip görevi", "CRM güncelle"]} onClick={() => openDetail("AI Satış Asistanı", "Lead için arama metni, WhatsApp, teklif, toplantı ve CRM takip hazırlık verisi üretir.", [{ label: "Lead Merkezi aç", target: "Lead Merkezi" }, { label: "Teklif oluştur", target: "Teklif Oluştur" }])} />
