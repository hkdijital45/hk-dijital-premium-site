...
export const adminNavigationGroups: AdminNavigationGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Tahsilatlar", slug: "muhasebe?tab=tahsilatlar", module: "tahsilat", description: "Ödeme kayıtları ve tahsilat durumu." },
      { label: "Gelir / Gider", slug: "muhasebe?tab=gelir-gider", module: "karlilik", description: "Gelir ve giderleri tek tabloda takip edin." },
      { label: "Kârlılık", slug: "muhasebe?tab=karlilik", module: "karlilik", description: "Müşteri bazlı kâr ve marj görünümü." },
      { label: "Muhasebe Raporları", slug: "muhasebe?tab=raporlar", module: "muhasebe-export", description: "Finans raporları ve dışa aktarma." }
    ]
  },
  {
    label: "İçerik & AI",
