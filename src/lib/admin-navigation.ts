...
const adminNavigationSourceGroups: AdminNavigationGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Social Autopilot", slug: "social-autopilot", module: "social-autopilot", description: "Instagram için otonom strateji, içerik üretimi, kalite kontrolü, yayın kuyruğu ve performans öğrenmesi." },
