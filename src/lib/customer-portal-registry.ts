...
export const CUSTOMER_MODULE_REGISTRY: CustomerModuleDefinition[] = [
  ...
  { key: "billing", title: "Tahsilat ve Ödemeler", description: "Ödeme planı ve tahsilat bilgileri.", routeHash: "odemeler" },
  ...
  { key: "ad_insights", title: "Reklamlar", description: "Reklam performansı, yorumlar ve fırsat önerileri.", routeHash: "performans" },
