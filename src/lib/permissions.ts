...
export const adminModules = [
  ...
  "growth-intelligence", "customer-risk", "ad-optimization", "seo-autopilot", "operational-quality", "ai-workforce", "social-autopilot",
  "analiz-raporlama", "on-inceleme"
] as const;
...
const moduleAliases: Record<string, AdminModule> = {
  ...
  "kullanici-yonetimi": "kullanicilar",
  "roller-yetkiler": "kullanicilar"
};
...
export const roleTemplates: Record<CanonicalRole, AdminModule[]> = {
  ...
  yonetici: [
    ...
    "customer-risk", "ad-optimization", "seo-autopilot", "operational-quality", "social-autopilot", "analiz-raporlama", "on-inceleme"
  ],
  editor: [
    "dashboard", "genel-arama", "kullanim-kilavuzu", "crm", "leads", "hazirlik",
    "ai-studio", "agent-hub", "blog-seo", "growth-intelligence", "seo-autopilot", "social-autopilot", "icerik-onerileri", "prompt-kutuphanesi", "kampanya-hazirligi",
