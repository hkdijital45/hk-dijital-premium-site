// Editorial cliché / AI-tell detector. Dependency-free pure logic so it is
// directly unit-testable and reusable from both the quality gate and the
// content-generation retry loop. The blacklist itself lives in the
// social_cliche_blacklist table (editable from Autopilot Ayarları) — this
// module just applies it, plus a few structural heuristics that don't fit a
// flat phrase list (repetitive "X değil, Y" constructions, rhetorical-
// question openers).
