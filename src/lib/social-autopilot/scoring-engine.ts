// Content performance scoring (spec section 27). Weighted by the content's
// own CTA goal/objective rather than a single "likes-first" ranking — a
// follower-growth Reel and an authority carousel are judged on different
// metrics because they're trying to do different jobs.
import type { CtaGoal } from "./constants";
import type { SocialMetricSnapshot } from "./types";
...
export function computeContentScore(snapshot: SocialMetricSnapshot, ctaGoal?: string | null): number {
