...
const definitions: Array<[string, string, string, string]> = [
  ...
  ["HK CEO Masası nasıl kullanılır?", "HK Intelligence", "CEO ekranındaki her kart artık detay modalı, ilgili modüle geçiş, payload kopyalama, görev oluşturma veya Agent Hub aksiyonuna bağlanır.", "hk-intelligence-ceo"],
  ["Marketplace paketleri nasıl üretilir?", "HK Intelligence", "Marketplace bölümünde sektör kartlarından Prompt Üret, Workflow Üret, AI Team Kur, KPI Şablonu ve Rapor Şablonu aksiyonlarını çalıştırın.", "hk-intelligence-ceo"],
  ["Yeni paket nasıl oluşturulur?", "HK Intelligence", "Yeni Paket Üret butonunda sektör, hedef müşteri, hizmetler, bütçe aralığı, ana hedef, kanallar ve çıktı tipini girerek prompt, workflow, AI team, KPI, operasyon planı, teklif ve rapor başlıkları üretin.", "hk-intelligence-ceo"],
  ["Marketplace paketi nasıl uygulanır?", "HK Intelligence", "HK CEO Marketplace içinde Müşteriye Uygula butonuyla paketi seçin, aktif müşteriyi arayıp seçin, oluşturulacak kayıtları işaretleyin, önizlemeyi kontrol edin ve Paketi Uygula ile işlemi tamamlayın.", "hk-intelligence-ceo"],
  ["Paket uygulayınca hangi kayıtlar oluşur?", "HK Intelligence", "Seçeneklere göre AI Hafızası kaydı, müşteri notu, 30 günlük görev planı, Agent Hub workflow taslağı, KPI şablonu, rapor şablonu ve teklif taslağı hazırlanır; işlem sonucu uygulama loguna yazılır.", "hk-intelligence-ceo"],
  ["AI Hafızası neye yarar?", "HK Intelligence", "Marketplace stratejisi, operasyon planı ve önerilen AI ekibi müşteri bağlamına kaydedilir; sonraki Agent Hub ve HK Intelligence analizlerinde müşterinin geçmiş strateji hafızası olarak kullanılabilir.", "hk-intelligence-ceo"],
  ...
  ["Uygulama logları nerede görülür?", "HK Intelligence", "Marketplace paket uygulamaları hk_marketplace_package_applications tablosunda seçenekler, özet, oluşturulan kayıt referansları, hata ve uygulayan kullanıcı bilgisiyle tutulur.", "hk-intelligence-ceo"],
  ["AI ajanları nasıl düzenlenir?", "HK Intelligence", "HK Digital Team ajan kartını açıp ajan adı, rol, durum, sağlayıcı, yetkinlik, görev, başarı oranı, maliyet ve not alanlarını düzenleyin; Agent Hub’da çalıştırın.", "hk-intelligence-ceo"],
  ...
  ["Risk ve öneriler nasıl göreve dönüştürülür?", "HK Intelligence", "Risk Merkezi ve AI Recommendation Engine kartlarında detay açın; görev oluştur, müşteri profilini aç, Agent ile analiz et, not olarak kaydet veya uygulama planı üret seçeneklerini kullanın.", "hk-intelligence-ceo"],
  ...
  ["HK Digital Team", "HK Intelligence", "CEO, Satış Müdürü, CRM Uzmanı, Google Ads Uzmanı, Meta Ads Uzmanı, SEO Uzmanı, Creative Director, Data Analyst, Finance Manager ve Customer Success ajanlarının durumunu takip edin.", "hk-intelligence-ceo"],
  ...
  ["Digital Twin", "CRM & Müşteriler", "Her müşteri için son 12 ay Google, Meta, SEO, CRM, rapor, kreatif, landing page, rakip, tahsilat, toplantı, not ve yapılan işleri tek AI müşteri ikizinde analiz edin.", "hk-intelligence-ceo"],
  ["Marketplace hazır AI paketleri", "HK Intelligence", "Emlak, Klinik, Oto Galeri, Nail Studio, Diş Kliniği, Cafe, Restoran, Kuaför, Avukat ve Muhasebeci paketlerini prompt, workflow, AI Team, dashboard, KPI ve rapor şablonuyla kullanın.", "hk-intelligence-ceo"],
  ...
  ["AI Copilot Chat", "HK Intelligence", "Bu ay en çok kazandıran müşteri, kötü giden Google Ads hesapları, teklif hazırlama, Pixel kontrolü ve haftalık arama listesi gibi doğal dil sorularını HK Intelligence ile yanıtlayın.", "hk-intelligence-ceo"],
  ["Smart Command Palette", "Dashboard & Kontrol Merkezi", "Ctrl/Cmd+K mantığıyla müşteri açma, firma arama, görev/teklif/kampanya/rapor/tahsilat oluşturma ve sistem rehberi/QA/AI/Analytics ekranlarına gitme komutlarını çalıştırın.", "hk-intelligence-ceo"],
  ["Global Search Phase 4", "Dashboard & Kontrol Merkezi", "Müşteri, firma, görev, belge, rapor, tahsilat, kampanya, prompt, Agent Memory, AI eğitimi, log, workflow, benchmark ve notları kategori bazlı arayın.", "hk-intelligence-ceo"],
  ["Smart Notification Center", "Dashboard & Kontrol Merkezi", "Bilgi, başarı, uyarı, kritik, AI önerisi, müşteri, tahsilat, reklam, SEO, Google, Meta ve AI bildirimlerini okunabilir, arşivlenebilir ve filtrelenebilir şekilde yönetin.", "hk-intelligence-ceo"],
  ["Health Center Phase 4", "Sorun Giderme", "Database, Supabase, Storage, Cron, Queue, API, AI sağlayıcıları, Meta API, Google Ads API, GA4, Search Console, SMTP, Resend, Discord, Website, SSL, Domain ve Hosting sağlıklarını izleyin.", "hk-intelligence-ceo"],
  ...
  ["Backup Center Phase 4", "Ayarlar", "Otomatik günlük, haftalık, aylık yedek, tek tıkla tam yedek, yedek doğrulama, yedek karşılaştırma, geri yükleme, import/export logları ve içerik özetlerini yönetin.", "veri-aktarma"],
  ["Customer Timeline", "CRM & Müşteriler", "Müşteri oluşturuldu, ilk görüşme, teklif, sözleşme, ödeme, Pixel, GA4, Search Console, Google Ads, Meta, kampanya, rapor, tahsilat, toplantı, AI analiz, not ve görev olaylarını kronolojik izleyin.", "hk-intelligence-ceo"],
  ["AI Recommendation Engine", "HK Intelligence", "Remarketing, landing page, SEO, bütçe artışı/azaltışı, WhatsApp kampanyası, blog, video ve Reels önerilerini beklenen etki, zorluk, süre, maliyet ve başarı olasılığıyla okuyun.", "hk-intelligence-ceo"],
