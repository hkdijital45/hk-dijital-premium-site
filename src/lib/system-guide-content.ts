...
const definitions: Array<[string, string, string, string]> = [
  ...
  ["HK Operasyon Merkezi nasıl okunur?", "Dashboard & Kontrol Merkezi", "Dashboard’ın üstündeki AI Ajans Direktörü panelinden aranacak fırsat, takip edilecek teklif, eksik analiz, tahsilat ve hedef sinyallerini okuyun.", ""],
  ["Günlük yapılacaklar nasıl işaretlenir?", "Dashboard & Kontrol Merkezi", "AI tarafından önerilen günlük satış aksiyonlarını tamamlandıkça işaretleyin ve ilgili modüle Git butonuyla geçin.", ""],
  ["Satış KPI Paneli nasıl yorumlanır?", "Dashboard & Kontrol Merkezi", "Son 7 gündeki incelenen işletme, CRM’e eklenen kayıt, teklif, görüşme, kazanım ve kayıp oranlarını takip edin.", ""],
  ["Gelir Paneli nasıl kullanılır?", "Tahsilat & Karlılık", "Gerçekleşen gelir, beklenen gelir, teklif aşamasındaki gelir, tahsil edilmeyen gelir ve hedefe kalan tutarı birlikte değerlendirin.", "tahsilat"],
  ["Satış performansı kişi bazında nasıl okunur?", "Dashboard & Kontrol Merkezi", "Tek kullanıcıda Ben olarak görünen performans satırı ileride ekip üyeleri için teklif, görüşme ve başarı oranı takibine hazırlanmıştır.", ""],
  ...
  ["AI Öğrenme Sistemi ne işe yarar?", "HK Intelligence", "Kazanıldı ve Kaybedildi durumlarından sektör kapanış oranı öğrenilir; bu sinyal fırsat önceliği açıklamasında kullanılır.", "musteri-kesfi"],
  ["Müşteri yaşam boyu değeri nasıl okunur?", "HK Intelligence", "Ortalama müşteri süresi ve tahmini aylık hizmet bedelinden LTV yani yaşam boyu gelir tahmini üretilir.", "musteri-kesfi"],
  ["Dijital Eksiklik Analizi nasıl kullanılır?", "HK Intelligence", "Website, Google Business, Instagram, Facebook, WhatsApp, Pixel, Analytics, Google Ads, SEO ve yorum sinyallerini Var, Eksik veya Bilinmiyor olarak kontrol edin.", "musteri-kesfi"],
  ["AI İlk Görüşme Koçu nasıl kullanılır?", "HK Intelligence", "Fırsat kartındaki açılır alandan ilk açılış, sorular, itiraz cevabı ve kapanış cümlesini satış görüşmesine hazırlık için kullanın.", "musteri-kesfi"],
  ["İtiraz Kütüphanesi nasıl kullanılır?", "HK Intelligence", "Pahalı, ajansımız var, daha önce denedik ve bütçem yok gibi itiraz cevaplarını tek tıkla kopyalayın.", "musteri-kesfi"],
  ["Operasyon geçmişi timeline nasıl okunur?", "HK Intelligence", "Keşif, CRM aktarımı, AI analiz, teklif, telefon, takip, kazanım ve kayıp adımlarını zaman sırasıyla kontrol edin.", "musteri-kesfi"],
