...
const definitions: Array<[string, string, string, string]> = [
  ...
  ["Auto AI Router nedir?", "HK Agent Hub", "Görev tipi, maliyet, sağlayıcı durumu ve yedek akışa göre OpenAI, Gemini, Claude, Groq, Manus veya demo sağlayıcıyı otomatik seçin.", "agent-hub"],
  ...
  ["Agent Hub export ve e-posta taslakları", "HK Agent Hub", "Agent sonucundan Word, PDF, PowerPoint hazırlık verisi ve müşteriye gönderilebilir e-posta taslağı üretin.", "agent-hub"],
  ...
  ["Agent Hub Vercel env listesi", "HK Agent Hub", "Production’da OPENAI_API_KEY, GEMINI_API_KEY, GROQ_API_KEY, ANTHROPIC_API_KEY, OPENROUTER_API_KEY, MANUS_API_KEY, MANUS_API_BASE_URL, MANUS_API_ENDPOINT, OLLAMA_BASE_URL, AGENT_HUB_CRON_SECRET, SMTP/RESEND ve webhook env değerlerini Vercel Environment Variables alanına ekleyin.", "agent-hub"],
