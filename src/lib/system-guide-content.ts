...
const definitions: Array<[string, string, string, string]> = [
  ...
  ["İçerik & Yapay Zekâ menüsü nasıl kullanılır?", "Yapay Zekâ Stüdyosu", "Yapay Zekâ Stüdyosu, HK Agent Hub, Yapay Zekâ Satış Koçu, İçerik Planları, Promptlar, Medya ve Kampanya Önerileri üretim ve yapay zekâ destekli içerik işleri için kullanılır.", "ai-studio"],
